...
public class PhoneTypeDaoTests extends TestCase
{

    final Logger logger = LoggerFactory.getLogger(PhoneTypeDaoTests.class);
    ...
    // @Test
    public void XtestPhoneTypeSave()
    {
    ...
    // @Test
    public void XtestPhoneTypeUpdate()
    {
    ...
    public void testPhoneTypeRetrieve()
    {
        ...
        {
            System.out.println("phoneTypes=" + phoneTypes.toString());
        }
        ...
        for (PhoneTypeEntity phoneType : phoneTypes)
        {
            ...
            System.out.println("testPhoneTypeRetrieve: phoneType=" + phoneType.toString());
        }
    ...
    // @Test
    public void XtestPhoneTypeDelete()
    {
